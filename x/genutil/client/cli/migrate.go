...
import (
	...
	v018 "github.com/brc20-collab/brczero/x/genutil/client/legacy/v0_18"
)
...
Example:
$ %s migrate v0.11 /path/to/genesis.json --chain-id=brczero --genesis-time=2019-04-22T17:00:00Z
`, version.ServerName),
