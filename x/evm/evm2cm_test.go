...
import (
	...
	etypes "github.com/brc20-collab/brczero/x/evm/types"
)
...
func TestDecodeParam(t *testing.T) {
	testcases := []struct {
	...
	}{
		{
			...
			fnCheck: func(ctm []byte, err error) {
				require.NoError(t, err)
				data := `{"module": "staking","function": "deposit","data": "{\"delegator_address\": \"0xb2910e22bb23d129c02d122b77b462ceb0e89db9\",\"quantity\": {\"denom\": \"brc10\",\"amount\": \"1\"}}"}`
