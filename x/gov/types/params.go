...
import (
	...
	"github.com/brc20-collab/brczero/x/params/subspace"
)
...
type DepositParams struct {
	...
	MaxDepositPeriod time.Duration `json:"max_deposit_period,omitempty" yaml:"max_deposit_period,omitempty"` //  Maximum period for brc10 holders to deposit on a proposal. Initial value: 2 months
}
