...
// IBrc20EntryPointTransferableInscription is an auto generated low-level Go binding around an user-defined struct.
type IBrc20EntryPointTransferableInscription struct {
	InscriptionId     string
	InscriptionNumber int64
	Amount            string
	Tick              string
...
//
// Solidity: function getAllTickInformation() view returns((string,address,uint256,uint256,uint256,uint256,string,int64,string,string,uint32,uint64)[])
...
//
// Solidity: function getTickInformation(string tick) view returns((string,address,uint256,uint256,uint256,uint256,string,int64,string,string,uint32,uint64) tickInformation)
...
// GetUserAllTransferableTickInformation is a free data retrieval call binding the contract method 0xf7776528.
//
// Solidity: function getUserAllTransferableTickInformation(string addr) view returns((string,int64,string,string,string)[])
func (_BRC20EntryPoint *BRC20EntryPointCaller) GetUserAllTransferableTickInformation(opts *bind.CallOpts, addr string) ([]IBrc20EntryPointTransferableInscription, error) {
	var out []interface{}
	err := _BRC20EntryPoint.contract.Call(opts, &out, "getUserAllTransferableTickInformation", addr)

	if err != nil {
		return *new([]IBrc20EntryPointTransferableInscription), err
	}

	out0 := *abi.ConvertType(out[0], new([]IBrc20EntryPointTransferableInscription)).(*[]IBrc20EntryPointTransferableInscription)
...
//
// Solidity: function getUserAllTransferableTickInformation(string addr) view returns((string,int64,string,string,string)[])
func (_BRC20EntryPoint *BRC20EntryPointSession) GetUserAllTransferableTickInformation(addr string) ([]IBrc20EntryPointTransferableInscription, error) {
	return _BRC20EntryPoint.Contract.GetUserAllTransferableTickInformation(&_BRC20EntryPoint.CallOpts, addr)
}

// GetUserAllTransferableTickInformation is a free data retrieval call binding the contract method 0xf7776528.
//
// Solidity: function getUserAllTransferableTickInformation(string addr) view returns((string,int64,string,string,string)[])
func (_BRC20EntryPoint *BRC20EntryPointCallerSession) GetUserAllTransferableTickInformation(addr string) ([]IBrc20EntryPointTransferableInscription, error) {
	return _BRC20EntryPoint.Contract.GetUserAllTransferableTickInformation(&_BRC20EntryPoint.CallOpts, addr)
}

// GetUserTransferableTickInformation is a free data retrieval call binding the contract method 0x69fbe4a6.
//
// Solidity: function getUserTransferableTickInformation(string addr, string tick) view returns((string,int64,string,string,string) tickInformation)
func (_BRC20EntryPoint *BRC20EntryPointCaller) GetUserTransferableTickInformation(opts *bind.CallOpts, addr string, tick string) (IBrc20EntryPointTransferableInscription, error) {
	var out []interface{}
	err := _BRC20EntryPoint.contract.Call(opts, &out, "getUserTransferableTickInformation", addr, tick)
...
//
// Solidity: function getUserTransferableTickInformation(string addr, string tick) view returns((string,int64,string,string,string) tickInformation)
func (_BRC20EntryPoint *BRC20EntryPointSession) GetUserTransferableTickInformation(addr string, tick string) (IBrc20EntryPointTransferableInscription, error) {
	return _BRC20EntryPoint.Contract.GetUserTransferableTickInformation(&_BRC20EntryPoint.CallOpts, addr, tick)
}

// GetUserTransferableTickInformation is a free data retrieval call binding the contract method 0x69fbe4a6.
//
// Solidity: function getUserTransferableTickInformation(string addr, string tick) view returns((string,int64,string,string,string) tickInformation)
func (_BRC20EntryPoint *BRC20EntryPointCallerSession) GetUserTransferableTickInformation(addr string, tick string) (IBrc20EntryPointTransferableInscription, error) {
	return _BRC20EntryPoint.Contract.GetUserTransferableTickInformation(&_BRC20EntryPoint.CallOpts, addr, tick)
}
