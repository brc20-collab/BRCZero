...
import (
	...
	keeper2 "github.com/brc20-collab/brczero/x/vmbridge/keeper"
...
func (suite *KeeperTestSuite) TestSendToWasmEvent_Unpack() {
	...
	testCases := []struct {
		...
		},
		{
			"recipient is bytes",
			func() {
				testABIJson := "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"wasmAddr\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"bytes\",\"name\":\"recipient\",\"type\":\"bytes\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"__brczeroSendToWasm\",\"type\":\"event\"}]"
		...
		},
		{
			"wasmAddr is bytes",
			func() {
				testABIJson := "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"bytes\",\"name\":\"wasmAddr\",\"type\":\"bytes\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"__brczeroSendToWasm\",\"type\":\"event\"}]"
		...
		{
			"event __brczeroSendToWasm(string,uint256) ",
			func() {
				testABIJson := "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"__brczeroSendToWasm\",\"type\":\"event\"}]"
		...
		{
			"event __brczeroSendToWasm(string,string,string,uint256) ",
			func() {
				testABIJson := "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient2\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient1\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"__brczeroSendToWasm\",\"type\":\"event\"}]"
		...
		},
		{
			"amount is negative",
			func() {
				testABIJson := "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"wasmAddr\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"recipient\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"int8\",\"name\":\"amount\",\"type\":\"int8\"}],\"name\":\"__brczeroSendToWasm\",\"type\":\"event\"}]\n"
...
func (suite *KeeperTestSuite) TestCallToWasmEventHandler_Handle() {
	...
	testCases := []struct {
		...
		},
		{
			...
			errors.New("insufficient funds: insufficient account funds; 1.000000000000000000brc10 < 2.000000000000000000brc10"),
		},
		{
			"caller(exist),wasmContract(0x 20),value(-1),data(normal)",
			func() {
...
func (suite *KeeperTestSuite) TestCallToWasmEvent_Unpack() {
	...
	testCases := []struct {
		...
		{
			"event __brczeroCallToWasm(string,uint256) ",
			func() {
				testABIJson := "[{\n    \"anonymous\":false,\n    \"inputs\":[\n        {\n            \"indexed\":false,\n            \"internalType\":\"string\",\n            \"name\":\"wasmAddr\",\n            \"type\":\"string\"\n        },\n        {\n            \"indexed\":false,\n            \"internalType\":\"uint256\",\n            \"name\":\"value\",\n            \"type\":\"uint256\"\n        }\n    ],\n    \"name\":\"__brczeroCallToWasm\",\n    \"type\":\"event\"\n}]"
		...
		{
			"event __brczeroCallToWasm(string,uint256,string,string) ",
			func() {
				testABIJson := "[{\n    \"anonymous\":false,\n    \"inputs\":[\n        {\n            \"indexed\":false,\n            \"internalType\":\"string\",\n            \"name\":\"wasmAddr\",\n            \"type\":\"string\"\n        },\n        {\n            \"indexed\":false,\n            \"internalType\":\"uint256\",\n            \"name\":\"value\",\n            \"type\":\"uint256\"\n        },\n        {\n            \"indexed\":false,\n            \"internalType\":\"string\",\n            \"name\":\"calldata\",\n            \"type\":\"string\"\n        },\n        {\n            \"indexed\":false,\n            \"internalType\":\"string\",\n            \"name\":\"calldata1\",\n            \"type\":\"string\"\n        }\n    ],\n    \"name\":\"__brczeroCallToWasm\",\n    \"type\":\"event\"\n}]"
