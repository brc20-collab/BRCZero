...
import (
	...
	sdkparams "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/params"
)
...
type Params struct {
	...
	// Maximum period for brc10 holders to deposit on a dex list proposal. Initial value: 2 days
