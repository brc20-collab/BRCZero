...
func TestNewMsgTokenBurn(t *testing.T) {
	...
	testCase := []struct {
		...
		{NewMsgTokenBurn(decCoin1, addr), common.ErrInsufficientCoins(DefaultParamspace, "100.0000000000000000001brc10-ads")},
	}
...
func TestNewTokenMsgSend(t *testing.T) {
	...
	Errorcoins := sdk.SysCoins{
		sdk.NewDecCoinFromDec(brc10, sdk.NewDec(100)),
		sdk.NewDecCoinFromDec(brc10, sdk.NewDec(100)),
		sdk.NewDecCoinFromDec(brc10, sdk.NewDec(100)),
	}
	...
	testCase := []struct {
		...
		{NewMsgTokenSend(fromAddr, toAddr, Errorcoins), ErrInvalidCoins("100.000000000000000000brc10,100.000000000000000000brc10,100.000000000000000000brc10")},
...
func TestNewTokenMultiSend(t *testing.T) {
	...
	testCase := []struct {
		...
		{NewMsgMultiSend(fromAddr, transfers0), ErrInvalidCoins("0.000000000000000000brc10")},
...
func TestNewMsgTransferOwnership(t *testing.T) {
	...
	testCase := []struct {
		...
		{NewMsgTransferOwnership(fromAddr, toAddr, "1brc10-ads"), ErrConfirmOwnershipNotExistOrBlockTimeAfter()},
	}
	for _, msgCase := range testCase {
