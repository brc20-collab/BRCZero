...
func GenTx(msgs []sdk.Msg, accnums []uint64, seq []uint64, priv ...crypto.PrivKey) *auth.StdTx {
	...
	fee := auth.StdFee{
		// just for test - 0.01brc10 as fixed fee
...
func TestMsgTokenChown(t *testing.T) {
	...
	MsgErrorSupply := types.NewMsgTokenIssue(brc10, brc10, brc10, "okccc", strconv.FormatInt(int64(10*1e10), 10), testAccounts[0].baseAccount.Address, true)
...
ok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-b`,
	...
	//normal test
	symbName := "brc10-b85" //addTokenSuffix(ctx,keeper,common.NativeToken)
...
func TestTxFailedFeeTable(t *testing.T) {
	...
	// failed issue msg : not enough brc10s .
