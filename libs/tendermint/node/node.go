...
import (
	...
	bcv0 "github.com/brc20-collab/brczero/libs/tendermint/blockchain/v0"
	bcv1 "github.com/brc20-collab/brczero/libs/tendermint/blockchain/v1"
	bcv2 "github.com/brc20-collab/brczero/libs/tendermint/blockchain/v2"
	cfg "github.com/brc20-collab/brczero/libs/tendermint/config"
	"github.com/brc20-collab/brczero/libs/tendermint/consensus"
	cs "github.com/brc20-collab/brczero/libs/tendermint/consensus"
	...
	tmpubsub "github.com/brc20-collab/brczero/libs/tendermint/libs/pubsub"
	...
	"github.com/brc20-collab/brczero/libs/tendermint/p2p/pex"
	...
	grpccore "github.com/brc20-collab/brczero/libs/tendermint/rpc/grpc"
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/okx/brczero/libs/tendermint/issues/3523
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/okx/brczero/libs/tendermint/issues/3435
