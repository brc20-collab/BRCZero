...
import (
	...
	tmquery "github.com/brc20-collab/brczero/libs/tendermint/libs/pubsub/query"
	nm "github.com/brc20-collab/brczero/libs/tendermint/node"
	rpcclient "github.com/brc20-collab/brczero/libs/tendermint/rpc/client"
	"github.com/brc20-collab/brczero/libs/tendermint/rpc/core"
...
func (c *Local) MapTxhashTxid(btcHash string) (map[string]string, error) {
	return core.MapTxhashTxid(c.ctx, btcHash)
}
