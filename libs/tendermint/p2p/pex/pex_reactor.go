...
import (
	...
	"github.com/brc20-collab/brczero/libs/tendermint/p2p/conn"
)
...
func (r *Reactor) dialPeer(addr *p2p.NetAddress) error {
	...
	if err != nil {
		...
		markAddrInBobrc10asedOnErr(addr, r.book, err)
		switch err.(type) {
		case p2p.ErrSwitchAuthenticationFailure:
			// NOTE: addr is removed from addrbook in markAddrInBobrc10asedOnErr
...
func markAddrInBobrc10asedOnErr(addr *p2p.NetAddress, book AddrBook, err error) {
