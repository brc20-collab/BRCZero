...
import (
	...
	ibcmsg "github.com/brc20-collab/brczero/libs/cosmos-sdk/types/ibc-adapter"
	...
	authtypes "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/auth/exported"
	...
	tmprototypes "github.com/brc20-collab/brczero/libs/tendermint/proto/types"
	tmtypes "github.com/brc20-collab/brczero/libs/tendermint/types"
	tmprotoversion "github.com/brc20-collab/brczero/libs/tendermint/version"
	tmversion "github.com/brc20-collab/brczero/libs/tendermint/version"
	...
	brczeroapptypes "github.com/brc20-collab/brczero/app/types"
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string) TestChainI {
	...
	//balance = sdk.NewCoins(brczeroapptypes.NewPhotonCoin(amount))
...
func NewTestEthChain(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	...
	genesisAcc := &brczeroapptypes.EthAccount{
