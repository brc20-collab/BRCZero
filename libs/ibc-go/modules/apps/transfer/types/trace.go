...
// Examples:
//
//   - "portidone/channelidone/brc10" => DenomTrace{Path: "portidone/channelidone", BaseDenom: brc10}
//   - brc10 => DenomTrace{Path: "", BaseDenom: brc10}
...
//
//   - A valid base denomination (eg: 'brc10')
