...
import (
	...
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/x/gov/types"
...
func (suite *ProposalSuite) TestNewChangeDistributionTypeProposal() {
	testCases := []struct {
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coins\":{\"denom\":\"brc10\",\"amount\":\"1.000000000000000000\"}}",
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"denom\":\"brc10\",\"aamount\":\"1.000000000000000000\"}}",
			ErrExtraProposalParams("coin is nil"),
		},
		{
			"ActionMintedPerBlock, error json",
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"ddenom\":\"brc10\",\"amount\":\"1.000000000000000000\"}}",
			ErrExtraProposalParams("coin is nil"),
		},
		{
			"ActionMintedPerBlock, error json",
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"denom\":\"brc10\",\"amount\":\"-1.000000000000000000\"}}",
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"denom\":\"brc10b\",\"amount\":\"-1.000000000000000000\"}}",
			ErrExtraProposalParams("coin is nil"),
		},
		{
			"ActionMintedPerBlock, error json",
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"denom\":\"brc10b\",\"amount\":\"dfads\"}}",
			ErrExtraProposalParams("parse json error"),
		},
		{
		...
		},
		{
			...
			RandStr(types.MaxDescriptionLength),
			ActionMintedPerBlock,
			"{\"coin\":{\"denom\":\"brc10\",\"amount\":\"0.000000000000000000\"}}",
			nil,
		},
	}
