...
import (
	...
	ibctx "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/auth/ibc-tx"
	signingtypes "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/auth/ibcsigning"
	...
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/client/keys"
...
func CompleteAndBroadcastTxCLI(txBldr authtypes.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) error {
	...
	panic(hex.EncodeToString(txBytes))
