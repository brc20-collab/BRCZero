...
import (
	...
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/codec/unknownproto"
	...
	tx "github.com/brc20-collab/brczero/libs/cosmos-sdk/types/tx"
...
func constructMsgs(ibcTx *tx.Tx) ([]sdk.Msg, []sdk.Msg, error) {
	...
	for _, ibcMsg := range ibcTx.Body.Messages {
		...
		case DenomAdapterMsg:
			// ibc transfer brc10 is not allowed,should do filter
