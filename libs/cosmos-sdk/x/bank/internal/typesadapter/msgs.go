...
import (
	...
	brczero_types "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/bank/internal/types"
...
func (msg *MsgMultiSend) ValidateBasic() error {
	...
	if len(msg.Inputs) == 0 {
		return brczero_types.ErrNoInputs
	}
	if len(msg.Outputs) == 0 {
		return brczero_types.ErrNoOutputs
	}
...
func ValidateInputsOutputs(inputs []Input, outputs []Output) error {
	...
	if !totalIn.IsEqual(totalOut) {
		return brczero_types.ErrInputOutputMismatch
	}
