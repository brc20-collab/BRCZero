...
import (
	...
	types "github.com/brc20-collab/brczero/libs/cosmos-sdk/types/ibc-adapter"
)
...
func (t *BroadcastTxResponse) HandleResponse(codec *codec.CodecProxy, data interface{}) interface{} {
	...
	logs := convbrczeroLogs2Proto(resp.Logs)
...
func convbrczeroLogs2Proto(ls sdktypes.ABCIMessageLogs) types.ABCIMessageLogs {
